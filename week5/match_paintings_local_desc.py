...
def parse_input_args():
    ...
    parser.add_argument("--output_bg_coords", type=str,
                        help="output folder to save predicted painting bboxes")
...
def match_paintings(args):
    ...
    if args.output_bg_coords:
        to_pkl(rotated_bboxes, args.output_bg_coords)
